...
namespace Workshop.Authentication.Controllers
{
    [SecurityHeaders]
    [AllowAnonymous]
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    //Add roles here
                    string role = WorkshopConstants.UserRole;
                    if (_superUserEmailGroup.Contains(user.Email))
                    {
                        role = WorkshopConstants.SuperUserRole;
                    }
